...
namespace NobleMuffins.LimbHacker
{
    public class Hackable : MonoBehaviour, ISliceable
    {
        ...
        public void Slice(Vector3 positionInWorldSpace, Vector3 normalInWorldSpace)
        {
            ...
            //clean up
            gameObject.layer = 13;
            Destroy(gameObject.GetComponent<EnemyVision>());
            Destroy(gameObject.GetComponent<Enemy>());
            Destroy(gameObject.GetComponentInChildren<VisionCone>());
            ...
            ChaserEnemy chaserEn = gameObject.GetComponent<ChaserEnemy>();

            Destroy(gameObject.GetComponentInChildren<TargetScript>());
