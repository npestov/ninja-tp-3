...
#pragma warning restore 0649
		...
		{
			UnityEngine.Debug.Log("PREPARE DATA 1");
		...
		{
			UnityEngine.Debug.Log("start ragdoll");
			//temp clean up
			go.layer = 13;
			Destroy(go.GetComponent<EnemyVision>());
			Destroy(go.GetComponent<Enemy>());
			Destroy(go.GetComponentInChildren<VisionCone>());
